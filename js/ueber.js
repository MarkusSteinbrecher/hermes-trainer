  ...
  function renderUeber(behaelter) {
    var prosa = h('div', { class: 'prosa' }, [
      ...
      h('ul', {}, [
        ...
        h('li', {}, [h('b', { text: 'Trainer: ' }), 'drei Übungsformen unter einem Dach. Zuordnen: Ausschnitte aus dem Graph der Methode in der klassischen Vorgehensweise — je Phase, je Modul oder alles — mit leeren Kästen für Rollen, Aufgaben und Ergebnisse; die Elemente liegen daneben bereit und werden an ihren Platz gezogen, die Verbindungen helfen dabei, die Prüfung zeigt richtig, falsch und offen. Lernkarten: Begriff ↔ Definition mit Selbsteinschätzung. Quiz: kuratierte Prüfungsfragen mit Belegzitat aus dem Handbuch sowie automatisch aus den Elementkarten erzeugte Fragen. Der Lernstand bleibt lokal im Browser.']),
