  ...
  function renderUeber(behaelter, params) {
    ...
    var prosa = h('div', { class: 'prosa' }, [
      ...
      h('ul', {}, [
        ...
        h('li', {}, [h('b', { text: 'Trainer: ' }), 'drei Übungsformen unter einem Dach. Zuordnen: Rollen, Aufgaben und Ergebnisse der klassischen oder der agilen Vorgehensweise — je Phase, je Modul oder alles —, je Aufgabe eine Zeile mit der verantwortlichen Rolle links und den erzeugten Ergebnissen rechts, alles in leeren Kästen; die Elemente liegen daneben bereit und werden an ihren Platz gezogen, die Prüfung bewertet die Zuordnung (nicht die Reihenfolge) und zeigt richtig, falsch und offen. Lernkarten: zu jeder Aufgabe und jedem Ergebnis der Zusammenhang — Phase, Modul, verantwortliche Rolle und die erzeugten Ergebnisse bzw. die Aufgaben, aus denen es entsteht. Je Bezug eine Zeile auf der Vorderseite, und gesucht sind alle Werte, die dort richtig sind (die meisten Elemente stehen in mehreren Phasen, die meisten Aufgaben erzeugen mehrere Ergebnisse); gewählt wird in einem Kombinationsfeld, in langen Listen mit Suche. Jede Wahl wird sofort geprüft, die erste falsche beendet die Zeile; die Rückseite zeigt die Lösung samt eigener Wahl und die Definition. Ohne Wahl geht es auch: Karte drehen und selbst einschätzen. Quiz: kuratierte Prüfungsfragen mit Belegzitat aus dem Handbuch sowie automatisch aus den Elementkarten erzeugte Fragen. Fortschritt: die Methode als Raster wie in der Übersicht — Phasen als Spalten, Module als Zeilen —, in jedem Feld der Stand seiner Rollen, Aufgaben und Ergebnisse; gezählt wird beim Prüfen im Zuordnen und bei den Lernkarten, nach dreimal richtig gilt ein Element als verstanden. Der Lernstand bleibt lokal im Browser.']),
