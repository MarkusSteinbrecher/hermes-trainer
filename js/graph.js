...
(function (global) {
  ...
  function leisteChip(text, gedrueckt, beiKlick, titel) {
    var b = h('button', {
      type: 'button', class: 'chip gleiste__chip', 'aria-pressed': gedrueckt ? 'true' : 'false', title: titel || null,
      on: { click: function () { tooltipVerbergen(); popSchliessen(); beiKlick(); } }
    }, [h('span', { text: text })]);
    return h('li', {}, b);
  }
