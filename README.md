...
- **Überblick** — oben das Gesamtbild der Methode (Abbildung 1 des Referenzhandbuchs) als Originalgrafik, darunter der Graph: Rollen, Aufgaben und Ergebnisse mit ihren Verbindungen, nach Phasen oder Modulen geordnet; beide Bereiche lassen sich zu- und aufklappen. Zeigen auf einen Kasten erklärt ihn, ein Klick hält ihn fest, und der Graph zeigt nur noch, was direkt damit zusammenhängt. Phasen, Szenarien und Module wählt die Leiste unter der Kopfzeile, sie gelten für beide; im Abfragemodus sind die Kästen der Abbildung verdeckt, und Sie suchen den richtigen Ort.
- **Suche** — oben in der Kopfzeile, auf jeder Seite: findet jedes Element, jedes Modul, jede Phase und jedes Szenario und zeigt es im Überblick. Im Überblick steht rechts daneben der Filter für Abbildung und Graph.
- **Trainer** — drei Übungsformen unter einem Dach, gewählt in der Leiste unter der Kopfzeile: *Zuordnen* (je Aufgabe die verantwortliche Rolle und die erzeugten Ergebnisse per Drag-and-drop in leere Kästen legen — je Phase, je Modul oder alles, klassisch oder agil; welche Arten leer sind, ist wählbar; «Prüfen» bewertet die Zuordnung, nicht die Reihenfolge), *Lernkarten* (Aufgaben und Ergebnisse und ihr Zusammenhang: vorne Begriff oder Definition und je Bezug ein Dropdown — Phase, Modul, verantwortliche Rolle und die Ergebnisse bzw. die Aufgaben, aus denen ein Ergebnis entsteht; jede Wahl wird sofort geprüft, nach der letzten dreht sich die Karte zur Lösung. Ohne Wahl geht es auch: Karte drehen und selbst einschätzen — was nicht sitzt, kommt wieder), *Quiz* (Prüfungsfragen mit Belegzitat aus dem Referenzhandbuch) und *Fortschritt* (die Methode als Raster — Phasen als Spalten, Module als Zeilen —, je Feld wie viel davon sitzt: nach dreimal richtig gilt ein Element als verstanden, eine falsche Antwort markiert das Feld, bis es wieder stimmt).
