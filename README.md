...
- **Trainer** — drei Übungsformen unter einem Dach: *Zuordnen* (Rollen, Aufgaben und Ergebnisse per Drag-and-drop in die leeren Kästen des Graphen legen — je Phase, je Modul oder alles, in der klassischen Vorgehensweise; welche Arten leer sind, ist wählbar, die Verbindungen bleiben stehen; «Prüfen» zeigt, was stimmt), *Lernkarten* (Begriff und Definition mit Selbsteinschätzung; was nicht sitzt, kommt wieder) und *Quiz* (Prüfungsfragen mit Belegzitat aus dem Referenzhandbuch).
