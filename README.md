...
- **Handbuch** — die Kapitel des Referenzhandbuchs in drei Stufen (Kernaussagen, Zusammenfassung, vollständiger Text) und darunter die Elemente des Kapitels: Phasen, Szenarien, Module, Aufgaben, Ergebnisse, Rollen und Grundbegriffe, je mit Link auf die offizielle Seite.
