...
- **Trainer** — drei Übungsformen unter einem Dach, gewählt in der Leiste unter der Kopfzeile: *Zuordnen* (je Aufgabe die verantwortliche Rolle und die erzeugten Ergebnisse per Drag-and-drop in leere Kästen legen — je Phase, je Modul oder alles, klassisch oder agil; welche Arten leer sind, ist wählbar; «Prüfen» bewertet die Zuordnung, nicht die Reihenfolge), *Lernkarten* (Aufgaben und Ergebnisse: vorne Begriff oder Definition, hinten verantwortliche Rolle, Ergebnisse bzw. Aufgaben, Modul und Definition; mit Selbsteinschätzung, was nicht sitzt, kommt wieder) und *Quiz* (Prüfungsfragen mit Belegzitat aus dem Referenzhandbuch).
